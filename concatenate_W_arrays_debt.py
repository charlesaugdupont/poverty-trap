...
if __name__ == "__main__":
	...
	W_arrays = {f'{SEED}':{}}
	for f in os.listdir(f"./model_runs_alternate_{SEED}/"):
		data = pickle.load(lzma.open(f"./model_runs_alternate_{SEED}/{f}"))
	...
	for seed_idx, seed in enumerate(W_arrays):
		...
		pickle.dump(W_SEED, lzma.open(output_dir + f"/{SEED}_debt.pkl.lzma", "wb"))