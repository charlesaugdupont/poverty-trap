...
if __name__ == "__main__":
	...
	G_arrays = {f'{SEED}':{}}
	for f in os.listdir(f"../model_runs_cpt_sda_{SEED}/"):
		data = pickle.load(lzma.open(f"../model_runs_cpt_sda_{SEED}/{f}"))
	...
	for seed_idx, seed in enumerate(G_arrays):
		...
		pickle.dump(G_SEED, lzma.open(output_dir + f"/G_{SEED}_{num_params}_{num_projects}_{num_steps}_cpt_sda.pkl.lzma", "wb"))